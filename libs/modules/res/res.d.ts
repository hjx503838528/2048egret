...
declare namespace RES {
    ...
    class ResourceLoader extends egret.EventDispatcher {
         ...
         */
        loadItem(resItem: ResourceItem, isPush?: boolean): void;
        /**
         * 资源解析库字典类
         */
        private analyzerDic;
...
declare namespace RES {
     ...
     * @language zh_CN
     */
    function getResByUrl(url: string, compFunc: Function, thisObject: any, type?: string, isPush?: boolean): void;
    /**
